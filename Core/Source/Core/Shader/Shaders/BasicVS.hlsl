...
VS_Out main(VS_In v)
{
	...
	o.worldPos = mul(float4(v.pos, 1.f), localTransforms[modelID]); // to model space
	o.worldPos = mul(o.worldPos, worldTransforms[instanceID]); // to world space
	o.pos = mul(o.worldPos, globalCBuffer.Camera.View);
